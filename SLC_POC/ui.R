...
ui <- dashboardPage(skin=c("red"),
                    ...
                    dashboardBody(
                      ...
                      (tabItem(tabName = "currentyearim",fluidPage(fluidRow(width=12,
